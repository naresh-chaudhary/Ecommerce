			...
			<div class="page_bar clearfix">
				<div class="row">
					<div class="col-md-10">
						...
						<p class="text-muted"><?php echo $rec_count;?> <a href="#">Orders</a></p>
					</div>
					<div class="col-md-2 text-right">
						<button class="btn btn-success">Add Orders</button>
					</div>
				</div>
			</div>
									...
									<table class="table info_table" id="prod_table">
										<thead>
											<tr>
												...
												$result=select('Orders','','',$rec_limit,$offset);
