...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Featured Items List</title>
    ...
    <body>
		...
		$rec_limit=10;
		$rec_count=totalrecords('FeaturedItems');
		if( isset($_GET{'page'} ) )
         {
            $page = $_GET{'page'} + 1;
		...
		<div id="main_wrapper">
			<div class="page_bar clearfix">
				<div class="row">
					<div class="col-md-10">
						<h1 class="page_title">Manage Featured Items</h1>
						<p class="text-muted"><?php echo $rec_count;?> <a href="#">Featured Items</a></p>
					</div>
					<div class="col-md-2 text-right">
						<button class="btn btn-success">Add Featured Items</button>
					</div>
				</div>
			</div>
									...
									<table class="table info_table" id="prod_table">
										<thead>
											<tr>
												...
												$result=select('FeaturedItems','','',$rec_limit,$offset);
