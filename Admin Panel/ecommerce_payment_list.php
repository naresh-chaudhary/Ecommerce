...
<html>
    ...
    <body>
		...
		$rec_limit=10;
		$rec_count=totalrecords('Payment');
		if( isset($_GET{'page'} ) )
         {
            $page = $_GET{'page'} + 1;
		...
		<div id="main_wrapper">
			<div class="page_bar clearfix">
				<div class="row">
					<div class="col-md-10">
						<h1 class="page_title">Manage Payments</h1>
						<p class="text-muted"><?php echo $rec_count;?> <a href="#">payments</a></p>
					</div>
									...
									<table class="table info_table" id="prod_table">
										<thead>
											<tr>
												...
												$result=select('Payment','','',$rec_limit,$offset);
