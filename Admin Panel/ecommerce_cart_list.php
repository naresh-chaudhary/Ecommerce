    ...
    <body>
		...
		<div id="main_wrapper">
			<div class="page_bar clearfix">
				<div class="row">
					<div class="col-md-10">
						<h1 class="page_title">Manage Cart</h1>
						<p class="text-muted"><?php echo $rec_count;?> <a href="#">cartitems</a></p>
					</div>
									...
									<table class="table info_table" id="prod_table">
										<thead>
											<tr>
												...
												$result=select('Cart','','',$rec_limit,$offset);
